...
def get_adjacency_matrix(distance_df, sensor_ids, normalized_k=0.1):
    ...
    print(f"{num_sensors} sensor ids")
...
def main_refer_gen_adj_mx(args):



    sensor_ids_filename="data/sensor_graph/graph_sensor_ids_"+args+".txt"
    distances_filename="data/sensor_graph/distances_"+args+".csv"
    normalized_k=0.1
    output_pkl_filename="data/sensor_graph/adj_mx_"+args+".pkl"
...
if __name__ == '__main__':
    ...
    parser.add_argument('--sensor_ids_filename', type=str, default='data/sensor_graph/graph_sensor_ids_Seoul_all.txt',
                        help='File containing sensor ids separated by comma.')
    parser.add_argument('--distances_filename', type=str, default='data/sensor_graph/distances_Seoul_all.csv',
    ...
    parser.add_argument('--output_pkl_filename', type=str, default='data/sensor_graph/adj_mx_Seoul_all.pkl',
